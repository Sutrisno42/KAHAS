...
const ChartsWidget2: React.FC<Props> = ({ className, title }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setChartData(response.data.data.yearly_transaction);
      } catch (error) {
  ...
  return {
    ...
    tooltip: {
      ...
      custom: function ({ series, seriesIndex, dataPointIndex }) {
        ...
        const transaction = data[dataPointIndex].total_transaction;

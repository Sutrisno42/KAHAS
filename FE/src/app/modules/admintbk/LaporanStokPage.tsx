                            ...
                            <table className=' table table-striped table-row-bordered table-row-white-100 align-middle gs-0 gy-3'>
                                ...
                                <thead>
                                    <tr className='fw-bold text-black'>
                                        ...
                                        <th className='min-w-120px'>Stok Saat Ini</th>
                                        <th className='min-w-120px'>HPP</th>
                            ...
                            <form>
                                <div className="mb-2">
                                    ...
                                    <input
                                        ...
                                        value={products.find(product => product.id === produkToProduk)?.product_name || ''}
                                        disabled
                                    />

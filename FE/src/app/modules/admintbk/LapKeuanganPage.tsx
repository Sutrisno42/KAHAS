...
import { convertIDR, formatDateSearch } from '../../functions/global';
...
function LapKeuanganPage() {
    ...
    const handlePencarian = (eventOrPageNumber: React.MouseEvent<HTMLButtonElement> | number) => {
        if (typeof eventOrPageNumber === 'number') {
            ...
            axios.get(`${API_URL}/report/financial?type=&page=&start_date=&end_date=`, {
                                    ...
                                    <ul className="pagination">
                                        ...
                                        <li className="page-item">
                                            <button className="page-link"
                                                onClick={() => handlePencarian(currentPage - 1)} disabled={currentPage === 1}
                                            >
                                                Sebelumnya
                                            </button>
                                        </li>

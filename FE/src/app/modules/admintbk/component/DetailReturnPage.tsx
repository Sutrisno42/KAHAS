...
import { refundHistory, showDetailReturn, showHistory, showSupplier, updateHistory } from '../../../functions/global/api';
                    ...
                    <div className=' card-header border-0'>
                        <div className='row gap-4 fw-bold'>
                            <div className=''>
                                ...
                                <span>Nama Kasir : {productHistory.data?.cashier?.name}</span>
                                <br />
                                <span>Periode Tanggal : {productHistory.data?.date_return}</span>
                            ...
                            <table className=' table table-striped table-row-bordered table-row-white-100 align-middle gs-0 gy-3'>
                                ...
                                <thead>
                                    <tr className='fw-bold text-muted'>
                                        ...
                                        <th className='min-w-30px'>stock</th>
                                    </tr>
                                </thead>
                                {/* end::Table head */}
                                {/* begin::Table body */}
                            ...
                            <table className=' table table-striped table-row-bordered table-row-white-100 align-middle gs-0 gy-3'>
                                ...
                                <thead>
                                    <tr className='fw-bold text-muted'>
                                        ...
                                        <th className='min-w-30px'>Discount</th>
                                        <th className='min-w-30px'>Discount Global</th>
                                ...
                                <tbody>
                                    <tr >
                                        ...
                                        <td className='text-dark fw-bold'>
                                            ...
                                            <span className='fw-bold d-block fs-7' style={{ color: 'green' }}>
                                                Payment: {productHistory.data?.transaction?.payment_method}</span>
                                        </td>

...
import History from '../pages/cassier/History'
import HistoryPage from '../modules/cassier/components/HistoryPage'
import DetailTransaksiPage from '../modules/cassier/components/DetailTransaksiPage'
import DetailReturnPage from '../modules/cassier/components/DetailReturnPage'
  ...
  return (
    <Routes>
      <Route element={<MasterLayout />}>
        ...
        <Route path='product/history/:product_id' element={<HistoryPage />} />
        <Route path='transaction/detailTransaksi/:transaction_id' element={<DetailTransaksiPage />} />
        <Route path='cassier/history-return/detail-return/:product_return_id' element={<DetailReturnPage />} />
